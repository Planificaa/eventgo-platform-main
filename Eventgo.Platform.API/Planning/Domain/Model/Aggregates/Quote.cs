...
namespace Eventgo.Platform.API.Planning.Domain.Model.Aggregates;
...
public class Quote
{
    ...
    public Quote(string title, ESocialEventType eventType,int guestQuantity, string location, double totalPrice, EQuoteStatus status,
