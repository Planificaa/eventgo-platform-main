...
public class QuotesController(IQuoteCommandService quoteCommandService, IQuoteQueryService quoteQueryService):ControllerBase
{
    [HttpGet("{quoteId}")]
    ...
    [HttpPost]
    [SwaggerOperation(Summary = "Creates a new quote", Description = "Creates a new quote and return the created quote resource", OperationId = "CreateQuote")]
