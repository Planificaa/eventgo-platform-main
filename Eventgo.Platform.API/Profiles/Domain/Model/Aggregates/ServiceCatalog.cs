...
namespace Eventgo.Platform.API.Profiles.Domain.Model.Aggregates;
...
public class ServiceCatalog
{
    ...
    public ServiceCatalog(int profileId, string title, string description, string category, decimal priceFrom, decimal priceTo)
    {
        ProfileId = profileId;
        Title = title;
    ...
    public ServiceCatalog(CreateServiceCatalogCommand command)
        : this(command.ProfileId, command.Title, command.Description, command.Category, command.PriceFrom, command.PriceTo)
    {
    }
