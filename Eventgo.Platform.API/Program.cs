using Eventgo.Platform.API.IAM.Application.Internal.CommandServices;
using Eventgo.Platform.API.IAM.Application.Internal.OutboundServices;
using Eventgo.Platform.API.IAM.Application.Internal.QueryServices;
using Eventgo.Platform.API.IAM.Domain.Repositories;
using Eventgo.Platform.API.IAM.Domain.Services;
using Eventgo.Platform.API.IAM.Infrastructure.Hashing.BCrypt.Services;
using Eventgo.Platform.API.IAM.Infrastructure.Persistence.EFC.Repositories;
using Eventgo.Platform.API.IAM.Infrastructure.Pipeline.Middleware.Extensions;
using Eventgo.Platform.API.IAM.Infrastructure.Tokens.JWT.Configuration;
using Eventgo.Platform.API.IAM.Infrastructure.Tokens.JWT.Services;
using Eventgo.Platform.API.IAM.Interfaces.ACL;
using Eventgo.Platform.API.IAM.Interfaces.ACL.Services;
using Eventgo.Platform.API.Operation.Application.Internal.CommandServices;
using Eventgo.Platform.API.Operation.Application.Internal.QueryService;
using Eventgo.Platform.API.Operation.Domain.Repositories;
using Eventgo.Platform.API.Operation.Domain.Services;
using Eventgo.Platform.API.Operation.infrastructure.Persistence.EFC.Repositories;
using Eventgo.Platform.API.Planning.Application.ACL;
using Eventgo.Platform.API.Planning.Application.Internal.CommandServices;
using Eventgo.Platform.API.Planning.Application.Internal.QueryServices;
using Eventgo.Platform.API.Planning.Domain.Repositories;
using Eventgo.Platform.API.Planning.Domain.Services;
using Eventgo.Platform.API.Planning.Infrastructure.Persistence.EFC.Repositories;
using Eventgo.Platform.API.Profiles.Application.ACL;
using Eventgo.Platform.API.Profiles.Application.Internal.CommandServices;
using Eventgo.Platform.API.Profiles.Application.Internal.QueryServices;
using Eventgo.Platform.API.Profiles.Domain.Repositories;
using Eventgo.Platform.API.Profiles.Domain.Services;
using Eventgo.Platform.API.Profiles.Infrastructure.Persistence.EFC.Repositories;
...
using Eventgo.Platform.API.Shared.Infrastructure.Interfaces.ASP.Configuration;
...
builder.Services.AddSwaggerGen(options => {
    ...
    {
        Title = "Planificaa.Eventgo.Platform.API",
        Version = "v1",
        Description = "Eventgo Platform API",
        TermsOfService = new Uri("https://Planificaa.Eventgo.com/tos"),
        Contact = new OpenApiContact
        {
            Name = "Planificaa",
            Email = "contact.Eventgo@Planificaa.com"
        },
